...
// Simple setting
recognition.continuous = true; // Set true if you want it continuous to recognize
...
recognition.onresult = function(event) {
    ...
    if (setTestingText != final_transcript) {
        setTestingText = final_transcript;
        resultCallback(final_transcript);
    }
